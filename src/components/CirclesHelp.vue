<template>
  <div style="text-align:left;">
    ...
    >
    gives a relation for the circle curvatures or "bends" (or 1/radius) of the
    circles:<br /><span class="equ"
      >(b<sub>1</sub>&nbsp;+&nbsp;b<sub>2</sub>&nbsp;+&nbsp;b<sub>3</sub>&nbsp;+&nbsp;b<sub>4</sub>)<sup>2</sup>&nbsp;
      =&nbsp;2(b<sub>1</sub><sup>2</sup>&nbsp;+&nbsp;b<sub>2</sub
      ><sup>2</sup>&nbsp;+&nbsp;b<sub>3</sub><sup>2</sup>&nbsp;+&nbsp;b<sub
        >4</sub
      ><sup>2</sup>)</span
    ><br />
    Solving this will give two answers. The relationship between answers:<br /><span
      class="equ"
    >
      b<sub>4</sub>&nbsp;+&nbsp;b<sub>4</sub>'&nbsp;=&nbsp;2(b<sub>1</sub>&nbsp;+&nbsp;b<sub>2</sub>&nbsp;+&nbsp;b<sub>3</sub>)</span
    ><br />
    This is used when there are four known circles and the fifth one needs to be
    found.<br />
    Calculating the radii is now done. To find the centers for the next
    circle(s) can be done with this relation:<br />
    <span class="equ"
    ...
    ><br />
    This relation is very nice because the amount of complex arithmetic is
    less.<br />
...
@Component({})
export default class CirclesHelp extends Vue {}
</script>
